...
@Component({
  selector: 'app-portal-chart3',
  templateUrl: './portal-chart3.component.html',
  styleUrls: ['./portal-chart3.component.css']
})
export class PortalChart3Component implements OnInit {
  options:any;
  ...
  ngOnInit() {
    console.log("显示折线图3")
    var color = ['#5793f3','#d14a61','#e15e12'];
    this.options = {
      color:color,
