...
@Component({
  selector: 'app-productarea-manage',
  templateUrl: './productarea-manage.component.html',
  styleUrls: ['./productarea-manage.component.css']
})
export class ProductareaManageComponent implements OnInit {
  ...
  getListSearch(data: any): void {
    ...
    params.url = `${environment.baseUrlSystem}productarea/getProductarea`;
    params.data = data;
  ...
  btnAdd(): void {
    ...
    this.router.navigate(['/system/baseInformation/productareaAdd']);
  }
  //更新
  btnUpdate(data: any): void {
    ...
    sessionStorage.removeItem('productareaData');
    this.router.navigate(['/system/baseInformation/productareaAdd']);
    sessionStorage.setItem('productareaData', JSON.stringify(data));
  ...
  deleteData() {
    const params = {url: '', data: {tProdutareaModels: []}, method: 'POST'};
    params.url = `${environment.baseUrlSystem}productarea/deleteProductarea`;
    params.data.tProdutareaModels = this.selectedData;
