...
@Component({
  selector: 'app-stock-bulk-in',
  templateUrl: './stock-bulk-in.component.html',
  styleUrls: ['./stock-bulk-in.component.css']
})
export class StockBulkInComponent implements OnInit {
...
// 页面grid 左右分栏
  ...
  btnClick(data: any): void {
    ...
    switch (data.buttonId) {
      case 'Add':
        this.router.navigate(['/system/stock/stockBulkInAdd']);
        break;
      case 'audit':
        this.audit();
        break;
