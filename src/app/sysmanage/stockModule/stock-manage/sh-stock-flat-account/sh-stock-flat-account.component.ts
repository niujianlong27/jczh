...
@Component({
  selector: 'app-sh-stock-flat-account',
  templateUrl: './sh-stock-flat-account.component.html',
  styleUrls: ['./sh-stock-flat-account.component.css']
})
export class ShStockFlatAccountComponent implements OnInit {
  tplModal: NzModalRef;
