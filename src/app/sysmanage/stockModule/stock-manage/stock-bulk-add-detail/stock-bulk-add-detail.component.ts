...
@Component({
  selector: 'app-stock-bulk-add-detail',
  templateUrl: './stock-bulk-add-detail.component.html',
  styleUrls: ['./stock-bulk-add-detail.component.css']
})
export class StockBulkAddDetailComponent implements OnInit {
  tplModal: NzModalRef;
  listLoading1: boolean = false;
  dataSet1: any = [];
  totalPages1: number = 0;
  pageSize1: number = 30;
  formId: any = 'form_bulk_add_detail';
  origin: any;
  backUrl: any;
  obj: any;
  pageStatus: any = '';
  ...
  ngOnInit() {
    ...
    switch (this.origin) {
      case 'stock_bulk_move':
        this.backUrl = '/system/stock/stockBulkMoveAdd';
        this.pageStatus = '1'; //散货移库
        break;
      case 'stock_bulk_inventory':
        this.backUrl = '/system/stock/stockBulkInventoryAdd';
        this.pageStatus = '2'; //散货盘库
        break;
      case 'stock_bulk_reverse':
        this.backUrl = '/system/stock/stockBulkReverseShipmentAdd';
        this.pageStatus = '3'; //散货倒运
        break;
      case 'stock_bulk_transfer':
        this.backUrl = '/system/stock/stockBulkTransferAdd';
        this.pageStatus = '4'; //散货盘库
        break;
      case 'stock_bulk_out':
        this.backUrl = '/system/stock/stockBulkOutAdd';
        this.pageStatus = '5'; //散货出库
        break;
      default:
        break;
    }
