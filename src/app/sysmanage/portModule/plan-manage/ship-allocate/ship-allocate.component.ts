...
/**
 * Title: ship-allocate.component.ts
 * Description: 装船计划页面
 * Created: pengzitong 2019/1/24
 * Modified:
 */
@Component({
  selector: 'app-ship-allocate',
  templateUrl: './ship-allocate.component.html',
  styleUrls: ['./ship-allocate.component.css']
})
export class ShipAllocateComponent implements OnInit {
  dataSet1:any = [];
  pageSize1:any = 30;
  totalPages1:any = 0;
