...
/**
 * Title: ship-ment.component.ts
 * Description: 装船确认页面
 * Created: pengzitong 2019/1/24
 * Modified:
 */
@Component({
  selector: 'app-ship-ment',
  templateUrl: './ship-ment.component.html',
  styleUrls: ['./ship-ment.component.css']
})
export class ShipMentComponent implements OnInit {
  ...
  modalFormData: Array<any> = [
    {
      name: '船运单号', eName: 'billNum', type: 'text', validateCon: '请填写作业计划号', require: false,placeholder:'自动生成',readOnly:true,
      validators: {
        require: false
      }
    },
