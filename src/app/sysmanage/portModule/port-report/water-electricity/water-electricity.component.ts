...
@Component({
  ...
  templateUrl: './water-electricity.component.html',
  styleUrls: ['./water-electricity.component.css']
})
export class WaterElectricityComponent implements OnInit {
  tplModal: NzModalRef;
  ...
  getList1(data: any): void {
    let url = portUrl.selectwaterAndPower;
  ...
  export(){  //导出
    let url: any = portUrl.waterAndPower;
