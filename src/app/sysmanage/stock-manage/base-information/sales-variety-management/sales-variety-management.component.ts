...
@Component({
  selector: 'app-sales-variety-management',
  templateUrl: './sales-variety-management.component.html',
  styleUrls: ['./sales-variety-management.component.css']
})
export class SalesVarietyManagementComponent implements OnInit {

  modalFormData: Array<any> = [
    {
      name: 'CORPID', eName: 'corpId', type: 'text', validateCon: '请输入CORPID', require: false,
      validators: {
        require: false,
        pattern: false,
      }
    ...
    {
      name: '材料号', eName: 'itemId', type: 'text', validateCon: '请输入材料号', require: true,
      validators: {
        require: true,
        pattern: false,
      }
    ...
    {
      name: '品种', eName: 'cName', type: 'text', validateCon: '请输入品种', require: true,
      validators: {
        require: true,
        pattern: false,
      }
    ...
    {
      name: '规则', eName: 'spec', type: 'text', validateCon: '请输入规则', require: false,
      validators: {
        require: false,
        pattern: false,
      }
    ...
    {
      name: '品种类型', eName: 'itemType', type: 'text', validateCon: '请输入品种类型', require: false,
      validators: {
        require: false,
        pattern: false,
      }
    ...
    {
      name: '品种大类', eName: 'classId', type: 'text', validateCon: '请输入品种大类', require: false,
      validators: {
        require: false,
        pattern: false,
      }
    ...
    {
      name: '品种分组', eName: 'groupId', type: 'text', validateCon: '请输入品种分组', require: false,
      validators: {
        require: false,
        pattern: false,
      }
  ...
  getListSearch(data: any): void {
    ...
    params.url = stockManageURL.selectItema;
    params.data = data;
  ...
  exportRequest(): Subscription {
    const url = stockManageURL.getItemaExcel;
  ...
  deleteRequest(): Promise<void> {
    const url = stockManageURL.deleteItema;
    const param = {
      itemaModels: []
    };
    this.selectedData.forEach(
      value => {
        param.itemaModels.push({rowid: value.rowid});
      }
    );
  ...
  addData() {
    ...
    const url = stockManageURL.insertItema;
   ...
   */
  updateData() {
    const url = stockManageURL.updateItema;
    const params = this.modalValidateForm.getRawValue();
