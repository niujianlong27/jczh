...
@Component({
  selector: 'app-deposit-notice',
  templateUrl: './deposit-notice.component.html',
  styleUrls: ['./deposit-notice.component.css']
})
export class DepositNoticeComponent implements OnInit {
  deleteCon: string;
  status: string;
  ...
  getListSearch(data: any): void {
    ...
    params.url = urls.getBclpStackingInfoMain;
    params.data = data;
  ...
  out(){
    let url: any = urls.exportBclpStackingInfoDetail;
