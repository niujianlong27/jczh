...
@Component({
  selector: 'app-deposit-outside',
  templateUrl: './deposit-outside.component.html',
  styleUrls: ['./deposit-outside.component.css']
})
export class DepositOutsideComponent implements OnInit {
